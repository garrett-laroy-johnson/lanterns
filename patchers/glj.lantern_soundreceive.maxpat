...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.427216, 120.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 253.0, 197.0, 76.0, 21.0 ],
					"style" : "",
					"text" : "loadmess #2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 253.0, 220.0, 43.0, 21.0 ],
					"style" : "",
					"triscale" : 0.9,
					"varname" : "position[5]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 184.427216, 179.779358, 55.0, 21.0 ],
					"style" : "",
					"text" : "route #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 184.427216, 156.346039, 57.0, 21.0 ],
					"style" : "",
					"text" : "route aed"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 112.0, 226.0, 58.0, 21.0 ],
									"style" : "",
									"text" : "onepole~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 112.0, 201.0, 33.0, 21.0 ],
									"style" : "",
									"text" : "sig~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 32.0, 263.0, 65.0, 21.0 ],
									"style" : "",
									"text" : "tapout~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 32.0, 226.0, 73.0, 21.0 ],
									"style" : "",
									"text" : "tapin~ 2000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 112.0, 121.0, 48.0, 21.0 ],
									"style" : "",
									"text" : "zl nth 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 112.0, 152.0, 32.5, 21.0 ],
									"style" : "",
									"text" : "* 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 112.0, 176.0, 54.0, 21.0 ],
									"style" : "",
									"text" : "/ 0.3438"
								}
...
,
					"patching_rect" : [ 114.064453, 244.5, 158.0, 21.0 ],
...
,
					"patching_rect" : [ 114.064453, 204.328583, 73.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.064453, 287.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 157.0, 92.0, 139.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 112.0, 54.0, 148.0, 22.0 ],
					"style" : "",
